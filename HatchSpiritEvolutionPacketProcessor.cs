...
namespace DigitalWorldOnline.Game.PacketProcessors
{
    public class HatchSpiritEvolutionPacketProcessor : IGamePacketProcessor
    {
        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            {
                CheckMaterialsInInventory(client,extraEvolution.Requireds,"required");
            }
        ...
        private void CheckMaterialsInInventory(GameClient client, List<ExtraEvolutionRequiredAssetModel> requiredMaterials, string materialType)
        {
            ...
            for (int itemSlot = 0; itemSlot < client.Tamer.Inventory.Size; itemSlot++)
            {
                ...
                foundItemIds.Add(targetItem.ItemId);
                ...
                if (targetItemTrue == null)
                {
                    ...
                    client.Send(new SystemMessagePacket("Invalid item data detected."));
                    return;
                }
            }
            ...
            {
                int foundAmount = foundItemIds.Count(id => id == material.ItemId);

                if (foundAmount < material.Amount)
                {
                    ...
                    var banMessage = banProcessor.BanAccountWithMessage(client.AccountId, client.Tamer.Name,
                        ...
                        "Why are you gay and trying to cheat? Happy ban with video providing cheating.");
