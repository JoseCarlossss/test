...
namespace DigitalWorldOnline.Game.PacketProcessors
{
    public class ConsignedShopOpenPacketProcessor : IGamePacketProcessor
    {
        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            //_logger.Information($"--- ConsigmentShop Open Packet 1516 ---");
            ...
            foreach (var item in sellList)
            {
                ...
                if (item.Amount > HasQuanty)
                {
                    ...
                    //var banMessage = banProcessor.BanAccountWithMessage(client.AccountId, client.Tamer.Name, AccountBlockEnum.Permanent, "Cheating", client, "You tried to open consigned shop with amount you don't have using a cheat method, So be happy with ban!");
                    ...
                    _logger.Warning($"[ConsignedShop] :: {client.Tamer.Name} Tryed to sell item with another amount using Cheat!!");
                ...
                if (item.ItemInfo!.BoundType == 2)
                {
                    ...
                    _logger.Warning($"[ConsignedShop] :: {client.Tamer.Name} Tryed to sell item with another Pack03!!");
